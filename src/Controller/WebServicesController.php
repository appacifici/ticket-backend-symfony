...
class WebServicesController
{
    ...
    public function wsUser(RestManager $restManager, Request $request, int $id = null): JsonResponse
    {
        $response = $restManager->processRequest($request, 'wsUser', $id);
        return new JsonResponse($response, ( $response->httpCode ?? Response::HTTP_OK));
    }

    #[Route('/ws/event/{id}', methods: ['GET', 'POST', 'PUT', 'DELETE'], name: 'wsEvent')]
    public function wsEvent(RestManager $restManager, Request $request, int $id = null): JsonResponse
    {
    ...
    public function wsLocation(RestManager $restManager, Request $request, int $id = null): JsonResponse
    {
    ...
    public function wsPlace(RestManager $restManager, Request $request, int $id = null): JsonResponse
    {
    ...
    public function wsSector(RestManager $restManager, Request $request, int $id = null): JsonResponse
    {
