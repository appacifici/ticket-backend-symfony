...
final class Version20231008214149 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE transactions (id INT AUTO_INCREMENT NOT NULL, event_id INT DEFAULT NULL, ticket_id INT DEFAULT NULL, user_id INT DEFAULT NULL, transaction_hash VARCHAR(500) NOT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP, update_at DATETIME DEFAULT NULL, INDEX IDX_EAA81A4C71F7E88B (event_id), INDEX IDX_EAA81A4C700047D2 (ticket_id), INDEX IDX_EAA81A4CA76ED395 (user_id), UNIQUE INDEX unq_ticket (ticket_id, event_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, surname VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, UNIQUE INDEX unq_user_email (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
