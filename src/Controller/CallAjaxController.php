...
class CallAjaxController extends TemplateController
{
     ...
     */
    public function getDataBoxOverlayByEntityAction(ManagerRegistry $doctrine, Request $request, string $section, int $id):Response
    {
        $this->baseParameters();
        ...
        switch ($nameEntity) {
            case 'Alert':
                ...
                if( empty( $entity ) ) {
                    return new Response( 'Not Alert Entity' );
                } else {
